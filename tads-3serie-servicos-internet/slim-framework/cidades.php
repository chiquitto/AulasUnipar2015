...
<html lang="pt-br">
  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-xs-12"><h1>População das cidades</h1></div>
      </div>
        ...
        <div class="panel-body">
          ...
          <div class="row">
            ...
            <div class="col-xs-8">
              <div class="form-group">
                <label>Cidade:</label>
                <select class="form-control" id="fidcidade" name="idcidade"></select>
              </div>
            </div>
          </div>
          <div class="row">
    ...
    <script src="lib/cidades.js" type="text/javascript"></script>
